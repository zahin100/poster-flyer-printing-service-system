        ...
        <div class="details">
          <div class="recentOrders">
            ...
            <table>
              ...
              <tbody>
              <?php 
              $query = "SELECT orders.id, DATE_FORMAT(orders.date, '%d-%m-%Y %H:%i:%s') AS date, orders.customerId, orders.employeeId, orders.status, CONCAT(employee.firstName, ' ', employee.lastName) AS name FROM orders INNER JOIN employee ON orders.employeeId=employee.id ORDER BY id DESC;"; 
              $result = mysqli_query($conn, $query);
